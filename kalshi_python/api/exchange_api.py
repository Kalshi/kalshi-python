...
class ExchangeApi(object):
    ...
    def get_exchange_status(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.get_exchange_status_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_exchange_status_with_http_info(**kwargs)  # noqa: E501
            return data
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_exchange_status" % key
                )
            params[key] = val
        del params['kwargs']
