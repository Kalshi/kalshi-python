...
class GetBalanceResponse(object):
    ...
    def __init__(self, balance=None):  # noqa: E501
        """GetBalanceResponse - a model defined in Swagger"""  # noqa: E501
        self._balance = None
    ...
    @property
    def balance(self):
        """Gets the balance of this GetBalanceResponse.  # noqa: E501


        :return: The balance of this GetBalanceResponse.  # noqa: E501
        :rtype: Cent
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetBalanceResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetBalanceResponse):
            return False
